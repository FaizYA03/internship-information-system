    ...
    <div class="tab-pane fade" id="ruangan" role="tabpanel">
        ...
        <div class="card border-0 rounded-4 shadow-sm mb-4">
            <div class="card-body p-4">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <form action="{{ route('lab.kepala_sekolah.approval.ruangan_eksternal.approve', $ruangan->id) }}" method="POST">
                        @csrf
                        <button type="submit" class="btn btn-success rounded-pill px-4 btn-sm"
        ...
        <div class="modal fade" id="rejectRuanganModal{{ $ruangan->id }}" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <form action="{{ route('lab.kepala_sekolah.approval.ruangan_eksternal.reject', $ruangan->id) }}" method="POST">
                    @csrf
                    <div class="modal-content border-0 rounded-4">
                        <div class="modal-header border-0">
