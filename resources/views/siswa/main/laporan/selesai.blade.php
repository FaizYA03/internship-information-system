...
<div class="row mb-4">
    <div class="col-12 text-center text-md-start">
        ...
        <p class="text-muted small mb-0">Laporan Anda yang telah ditindaklanjuti dan diperbaiki oleh teknisi.</p>
    </div>
</div>
...
<div class="row g-4">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card border-0 shadow-sm rounded-4 h-100 border-start border-4 border-success">
                <div class="card-body">
                    ...
                    <p class="text-muted small mb-3"><i class="bi bi-calendar-check me-1"></i> Selesai pada {{ $l->updated_at->format('d M Y') }}</p>
    ...
    @empty
        <div class="col-12">
            <x-ui.empty-state icon="bi-check2-all" title="Belum Ada Perbaikan Selesai" description="Laporan Anda akan muncul di sini setelah statusnya ditandai selesai oleh admin." />
        </div>
    @endforelse
</div>
